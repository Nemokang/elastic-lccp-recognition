...
class IndexMap
{
    public:
        ...
        /*------------------- new add ------------*/
//        void setnormalTex(GPUTexture * normtex)
//        {
...
//        }
    ...
    private:
        ...
        GPUTexture imageTexture;//投影出来的rgb图像
        ...
        GPUTexture oldImageTexture;//显示不出效果
        GPUTexture oldVertexTexture;
        GPUTexture oldNormalTexture;
        GPUTexture oldTimeTexture;//显示不出效果

        pangolin::GlFramebuffer infoFrameBuffer;
        pangolin::GlRenderBuffer infoRenderBuffer;
        GPUTexture colorInfoTexture;//一堆彩色噪声点
        GPUTexture vertexInfoTexture;//一堆彩色噪声点
