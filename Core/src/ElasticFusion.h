...
#include "PoseMatch.h"
#include "Defines.h"
#include "Segmentation.h"/////////////////////////////////////////////new add
...
class ElasticFusion
{
    public:
        ...
        //Here be dragons
        //GPUTexture* labelTexture;///////////////////////////////////////new add
    private: 
        Segmentation segmentation;//----------------------------------------new add
        IndexMap indexMap;
        ...
        int frameNum=0;//--------------new add
        bool ifUpdatelabel=true;//-------new add
        int tick;
        const int timeDelta;
        ...
        Img<Eigen::Vector4f> normBuff;//=================================new add
        Img<Eigen::Vector4f> vertexBuff;//当前深度图优化后得到的顶点图 ===============new add=====================

        Img<Eigen::Vector4f> colorTimeBuff;//从indexMap.colorTimeTex()提取的--------------new add
        Img<Eigen::Vector4f> vertConfBuff;//indexMap.vertConfTexture()---------------new add
        Img<Eigen::Vector4f> normalRadBuff;//indexMap.normalRadTexture()---------------new add
