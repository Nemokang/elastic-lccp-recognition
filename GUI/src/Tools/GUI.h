...
class GUI
{
    public:
         ...
         : showcaseMode(showcaseMode)
        {
            ...
            //pangolin::Display(GPUTexture::LABEL_RGB).SetAspect(640.0f / 480.0f);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
drawSeg = new pangolin::Var<bool>("ui.Draw Seg", showcaseMode, true);
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            colorProgram->setUniform(Uniform("colorType", (drawNormals->Get() ? 1 : drawSeg->Get() ? 5 : drawColors->Get() ? 2 : drawTimes->Get() ? 3 : 0)));
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
