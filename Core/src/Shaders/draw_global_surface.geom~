...
else if(colorType0[0] == 5)////////////////////////新添加（作为显示Seg选项）
        {
            int temp = (int(vColor[0].y))%30;
            vColor0 = lcolorType[temp];

		//vec3 col=decodeColor(vColor[0].y);
		//int temp=int(col.x+col.y+col.z)%30;
		//vColor0 = lcolorType[temp];
