...
uniform sampler2D gSampler;//depth
uniform sampler2D cSampler;
uniform sampler2D lSampler;//---------------------------------------new add
...
void main()
{
    ...
    //vec4 lColor = textureLod(lSampler, texcoord.xy, 0.0);//---------------------------------------------------new add
    ...
    //vColor.y = encodeColor(lColor.xyz);//--------------------------------------------------初始值为0
